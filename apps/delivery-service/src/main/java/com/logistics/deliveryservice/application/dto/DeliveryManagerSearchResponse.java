...
public record DeliveryManagerSearchResponse(
        UUID userId,
    ...
    public static DeliveryManagerSearchResponse from(DeliveryManager deliveryManager) {
        return new DeliveryManagerSearchResponse(
