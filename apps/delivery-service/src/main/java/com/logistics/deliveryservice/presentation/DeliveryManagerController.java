...
import com.logistics.deliveryservice.application.service.CreateDeliveryManagerService;
...
public class DeliveryManagerController {
    ...
    private final CreateDeliveryManagerService createDeliveryManagerService;
    ...
    public ResponseEntity<ApiResponse<CreateDeliveryManagerResponse>> createDeliveryManager(
        ...
        CreateDeliveryManagerResponse response = createDeliveryManagerService.create(
                request.toCommand()
        );
