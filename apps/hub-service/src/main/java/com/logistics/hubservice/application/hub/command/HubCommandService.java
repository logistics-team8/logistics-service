...
public class HubCommandService {
    ...
    public HubCommandService(
            ...
            HubRouteCacheEvictor hubRouteCacheEvictor) {
        this.hubRepository = hubRepository;
        this.hubRouteRepository = hubRouteRepository;
        this.hubRouteCacheEvictor = hubRouteCacheEvictor;
    }
    ...
    public void delete(UUID hubId, UUID deletedBy) {
        ...
        connectedHubRoutes.forEach(
                hubRoute -> hubRouteCacheEvictor.evictHubRouteById(hubRoute.getId()));
