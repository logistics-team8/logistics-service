...
public class AuthService {
    ...
    public void logout(String accessToken) {
        try {
            ...
            refreshTokenRepository.delete(tokenPayload.userId());
            roleCacheRepository.delete(tokenPayload.userId());
     ...
     * @param role 사용자 권한
     * @returnTokenResult (AccessToken, RefreshToken)
     */
    private TokenResult createAuthResponse(TokenClaims tokenClaims, UUID sessionId, String role) {
        ...
        try {
            ...
            log.error("[Cache] Redis Role Cache 저장 실패 userId = {}", userId, e);
        }
